...
- **Major Features Added**: Chain code, motion signatures, dynamic depth scaling, palm angle tracking
- **Major Features Removed**: MiDaS integration

### Current Capabilities
- Real-time hand tracking (21 landmarks per hand)
- Face-relative 3D spatial tracking (160 voxel 2-layer grid)
- Dynamic depth-adaptive layer switching (Layer 0: face, Layer 1: camera)
- 3D motion signature (26-directional chain code)
- **NEW**: Real-time palm orientation angle tracking with change recording
